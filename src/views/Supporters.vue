<template>
    ...
    <div class="flex justify-center text-center">
        <div class="flex flex-col w-full max-w-5xl space-y-6">
            <div v-for="supporter in supporters" class="flex flex-col w-full p-6 space-y-3 text-left bg-black border-2 shadow-xl bg-opacity-80 border-neutral-300 rounded-xl">
